...
- (void)setMessage:(UUMessage *)message{
    ...
    if (_showTime){
        ...
        CGSize timeSize = [_message.strTime boundingRectWithSize:CGSizeMake(ChatTimeW, 100) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:ChatTimeFont} context:nil].size;
